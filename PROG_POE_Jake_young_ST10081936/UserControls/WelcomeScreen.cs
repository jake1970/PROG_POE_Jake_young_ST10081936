...
namespace PROG_POE_Jake_young_ST10081936
{
    public partial class WelcomeScreen : UserControl
    {
        ...
        private void InitialiseMenu()
        {
            ...
            //part three  (find call numbers) navigation components
            panel5.Click += new EventHandler(StartPartThree_Click);
            label4.Click += new EventHandler(StartPartThree_Click);



            //set the sound effect for mouse enter "hover"
            label5.MouseEnter += new EventHandler(Option_MouseEnter);
            label3.MouseEnter += new EventHandler(Option_MouseEnter);
            label4.MouseEnter += new EventHandler(Option_MouseEnter);
        ...
        //------------------------------------------------------------------------------------------------------------------
        /// <summary>
        /// Enter POE Part 3 - Find Call Numbers
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void StartPartThree_Click(object sender, EventArgs e)
        {
            //new sound manager object
            SoundManager soundEffect = new SoundManager();
            ...
            //show part two "Find Call Numbers"
            Form1 partThree = new Form1(3);
            partThree.Show();
        }
        //------------------------------------------------------------------------------------------------------------------
