...
namespace PROG_POE_Jake_young_ST10081936
{
    static class GlobalGameData
    {
        ...
        //------------------------------------------------------------------------------------------------------------------
        /// <summary>
        /// Method to create the third game "Find Call Numbers"
        /// </summary>
        /// <param name="parentValue"></param>
        /// <param name="gameMode"></param>
        public static void GenerateGameThree(Control parentValue)
        {

            //new dynamic component from the FindCallNumbers user control
            FindCallNumbers gameThree = new FindCallNumbers();

            //call method to format the game user control
            FormatControl(parentValue, gameThree);

            //set the forms text to the third game
            parentValue.Text = "Find Call Numbers";
        }
        //------------------------------------------------------------------------------------------------------------------
